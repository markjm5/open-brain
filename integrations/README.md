...
MCP server extensions, webhook receivers, and capture sources beyond your AI tools.
...
Integrations are open for community contributions. See [CONTRIBUTING.md](../CONTRIBUTING.md) for details.
